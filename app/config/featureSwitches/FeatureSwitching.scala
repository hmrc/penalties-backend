...
trait FeatureSwitching {
  ...
  final def setDisabledFeatureSwitches(featureSwitch: FeatureSwitch*): Unit = {
    enableFeatureSwitch(FeatureSwitch.listOfAllFeatureSwitches.diff(featureSwitch) :_*)
    disableFeatureSwitch(featureSwitch:_*)
  }
}
